...
exports.FindOneMoviesInUserListUseCase = void 0;
const tsyringe_1 = require("tsyringe");
let FindOneMoviesInUserListUseCase = class FindOneMoviesInUserListUseCase {
    constructor(usersMoviesRepository) {
        this.usersMoviesRepository = usersMoviesRepository;
    }
    execute({ userId, movieId, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const userMovie = yield this.usersMoviesRepository.findOne({
                user_id: userId,
                movie_id: movieId,
            });
            return {
...
FindOneMoviesInUserListUseCase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('UsersMoviesRepository')),
    __metadata("design:paramtypes", [Object])
], FindOneMoviesInUserListUseCase);
exports.FindOneMoviesInUserListUseCase = FindOneMoviesInUserListUseCase;
