...
exports.FindGroupsUsersUseCase = void 0;
const tsyringe_1 = require("tsyringe");
let FindGroupsUsersUseCase = class FindGroupsUsersUseCase {
    constructor(groupsUsersRepository) {
        this.groupsUsersRepository = groupsUsersRepository;
    }
    execute({ groupId, userId, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const groupsUsers = yield this.groupsUsersRepository.index({
                group_id: groupId,
                user_id: userId,
            });
...
FindGroupsUsersUseCase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('GroupsUsersRepository')),
    __metadata("design:paramtypes", [Object])
], FindGroupsUsersUseCase);
exports.FindGroupsUsersUseCase = FindGroupsUsersUseCase;
